...
create trigger update_customer_usernames_updated_at
...
create policy "customer_usernames_select_all" on public.customer_usernames for select using (true);
create policy "customer_usernames_insert_all" on public.customer_usernames for insert with check (true);
create policy "customer_usernames_update_all" on public.customer_usernames for update using (true);
